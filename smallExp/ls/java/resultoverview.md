...
## Parser Comparison 
 ...
 --- | --- | --- | ---
JavaScripturijs | 0 | 0 | 28.77% 
JavaScriptwhatwg-url | 0 | 0 | 60.51% 
Python | 0 | 0 | 43.0% 
firefox | 1 | 1 | 72.2% 
Cpp | 1 | 1 | 36.1% 
chromium | 1 | 1 | 48.68% 
...
### C
 ...
 Exception Type | URLs 
 --- | --- 
 ``` 1 ```  |  ``` ws://[::]?⍭ ```  <br> ``` https://%3d@" ```  <br> ``` file://ž2 ```  <br> ``` S:/ < //` ```  <br> ``` file:///+ ```  <br> ``` file://{ ```  <br> ``` file:/// < /%2e/琮 ```  <br> ``` wss://[::]?񴰅 ```  <br> ``` m:/ < /?ｷ ```  <br> ``` W:/? ```  <br> ``` O:/ < 𿇰 ```  <br> ``` http://[::]?﷎ ```  <br> ``` file:/// < /#￸ ```  <br> ``` T:/%﹯ ```  <br> ``` F:/ < //{v ```  <br> 
