...
## Parser Comparison 
 ...
 --- | --- | --- | ---
JavaScripturijs | 0 | 0 | 25.48% 
Cpp | 0 | 0 | 30.2% 
JavaScriptwhatwg-url | 0 | 0 | 55.29% 
Python | 0 | 0 | 43.0% 
firefox | 1 | 1 | 70.6% 
chromium | 1 | 1 | 47.18% 
Go | 2 | 2 | 73.8% 
...
### C
 ...
 Exception Type | URLs 
 --- | --- 
 ``` 1 ```  |  ``` ws://[::]?⍭ ```  <br> ``` https://%3d@" ```  <br> ``` file://ž2 ```  <br> ``` file:///+ ```  <br> ``` file://{ ```  <br> ``` file:/// < /%2e/琮 ```  <br> ``` m:/ < /?ｷ ```  <br> ``` W:/? ```  <br> ``` http://[::]?﷎ ```  <br> 
