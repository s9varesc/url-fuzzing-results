...
### Java
 ...
 ``` java.net.MalformedURLException: unknown protocol: p ```  |  ``` P:/ < //[::cfcc:253.88.251.253] ```  <br> ``` P:/. ```  <br> ``` P:/ < //[::fbaa:ceec:250.254.149.251] ```  <br> ``` p:/ < //%7d ```  <br> ``` p:/?ﺖ < / ```  <br> 
...
### Ruby
 ...
 ``` bad URI(is not URI?):  ```  |  ``` file://`$ ```  <br> ``` file://" ```  <br> ``` file:///^ ```  <br> ``` V:///]! ```  <br> ``` H://" ```  <br> 
