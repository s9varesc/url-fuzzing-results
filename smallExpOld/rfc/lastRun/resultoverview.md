...
PHP | 51 | 51 | 58.62% 
Ruby | 62 | 1 | 68.91% 
JavaScriptwhatwg-url | 73 | 1 | 36.21% 
Java | 100 | 26 | 36.0% 
...
### Java
 ...
 ``` java.net.MalformedURLException: unknown protocol: p ```  |  ``` p://* ```  <br> ``` p://[::affa:aefd:bdba:1.251.253.251%25~] ```  <br> 
 ``` java.net.MalformedURLException: unknown protocol: i ```  |  ``` I://[::250.253.200.252%25.] ```  <br> ``` i://[::eccf:bfec:dafb:dfca:fcbf:250.252.252.13%25_] ```  <br> 
 ...
 ``` java.net.MalformedURLException: unknown protocol: m ```  |  ``` m://[::ecaf:afae:cdcf:255.254.12.255] ```  <br> 
...
## URL Comparison 
 ...
 ``` m://[::ecaf:afae:cdcf:255.254.12.255] ```  | Java <br>
 ``` i://[::eccf:bfec:dafb:dfca:fcbf:250.252.252.13%25_] ```  | C <br>PHP <br>Java <br>JavaScriptwhatwg-url <br>Ruby <br>
 ``` p://[::affa:aefd:bdba:1.251.253.251%25~] ```  | C <br>PHP <br>Java <br>JavaScriptwhatwg-url <br>Ruby <br>
 ``` //[babd:efbe:ccdd:bfff:abed:cbbc:251.250.49.252] ```  | firefox <br>Java <br>JavaScriptwhatwg-url <br>chromium <br>Ruby <br>
