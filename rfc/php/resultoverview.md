...
chromium | 12 | 1 | 13.72% 
Ruby | 12 | 1 | 68.91% 
JavaScriptwhatwg-url | 16 | 1 | 34.28% 
Java | 22 | 9 | 36.0% 
...
### Java
 ...
 ``` java.net.MalformedURLException: unknown protocol: d ```  |  ``` d://255.76.253.254 ```  <br> ``` d://[::bedb:adea:6fdf:bdfa] ```  <br> 
