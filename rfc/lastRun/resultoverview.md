...
PHP | 44 | 44 | 58.62% 
Ruby | 52 | 1 | 68.91% 
JavaScriptwhatwg-url | 63 | 1 | 36.21% 
Java | 86 | 23 | 36.0% 
...
### Java
 ...
 ``` java.net.MalformedURLException: unknown protocol: w ```  |  ``` W://[fcbb:dcef:ddab:bfba:cdbb:beef:252.254.77.253%25-] ```  <br> ``` W://= ```  <br> ``` W://[::afbb:253.236.252.255%25_] ```  <br> ``` w://[::250.251.168.251] ```  <br> 
