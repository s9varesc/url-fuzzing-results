...
PHP | 33 | 33 | 58.62% 
Ruby | 40 | 1 | 68.91% 
JavaScriptwhatwg-url | 49 | 1 | 36.21% 
Java | 66 | 20 | 36.0% 
...
### Java
 ...
 ``` java.net.MalformedURLException: unknown protocol: q ```  |  ``` Q://[::aaad:cbfa:deea:36.255.253.254] ```  <br> ``` q://[1eac::fbbc%25-] ```  <br> 
 ``` java.net.MalformedURLException: unknown protocol: e ```  |  ``` E://[::fddb:bafe:efcb:254.114.254.255] ```  <br> ``` E://[::250.253.251.197%25.] ```  <br> ``` e://[fbaf::eace:bbae:bcae:fade:dafa:9dce%25.] ```  <br> 
