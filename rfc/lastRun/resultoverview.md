...
PHP | 39 | 39 | 58.62% 
Ruby | 46 | 1 | 68.91% 
JavaScriptwhatwg-url | 57 | 1 | 36.21% 
Java | 76 | 22 | 36.0% 
...
### Java
 ...
 ``` java.net.MalformedURLException: unknown protocol: w ```  |  ``` W://[fcbb:dcef:ddab:bfba:cdbb:beef:252.254.77.253%25-] ```  <br> ``` W://= ```  <br> ``` W://[::afbb:253.236.252.255%25_] ```  <br> 
 ...
 ``` java.net.MalformedURLException: unknown protocol: g ```  |  ``` g://[fbee:fcaa:caca:dadf:abae:adce:253.252.91.250] ```  <br> 
